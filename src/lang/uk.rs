...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About TerabithiaRemote", "Про TerabithiaRemote"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Будь ласка, оновіть TerabithiaRemote клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
