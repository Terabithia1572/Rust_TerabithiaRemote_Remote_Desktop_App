...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Website"),
        ("About", "Hakkında"),
        ("Slogan_tip", "Mu.Asb.Çvş.Yunus İNAN 2024-B.37 tarafından yazılmıştır. Tüm hakları saklıdır...!"),
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, TerabithiaRemote bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, TerabithiaRemote'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için TerabithiaRemote'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için TerabithiaRemote'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, TerabithiaRemote'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [TerabithiaRemote Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep RustDesk background service", "TerabithiaRemote arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki TerabithiaRemote uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show RustDesk", "TerabithiaRemote'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için TerabithiaRemote'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için TerabithiaRemote'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan TerabithiaRemote'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_rustdesk_password_tip", "TerabithiaRemote parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden TerabithiaRemote'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lütfen TerabithiaRemote Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, TerabithiaRemote'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "TerabithiaRemote tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca TerabithiaRemote penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "TerabithiaRemote arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About TerabithiaRemote", "TerabithiaRemote Hakkında"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lütfen uzak tarafta TerabithiaRemote istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, TerabithiaRemote sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda TerabithiaRemote doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, TerabithiaRemote artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: TerabithiaRemote sunucu OSS'si bu özelliği içermemektedir."),
