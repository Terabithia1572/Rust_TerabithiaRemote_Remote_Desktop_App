...
pub const PORTABLE_APPNAME_RUNTIME_ENV_KEY: &str = "TERABITHIAREMOTE_APPNAME";
...
pub fn is_rustdesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("TerabithiaRemote")
}
