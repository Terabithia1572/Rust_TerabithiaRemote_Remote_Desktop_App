...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"TerabithiaRemote Printer";
    LPCWCH RD_PRINTER_NAME = L"TerabithiaRemote Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"TerabithiaRemote v4 Printer Driver";
